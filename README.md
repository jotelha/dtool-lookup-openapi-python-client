# dtool-lookup-openapi-python-client
...
```sh
pip install git+https://github.com/jotelha/dtool-lookup-openapi-python-client.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/jotelha/dtool-lookup-openapi-python-client.git`)
